...
const timeline = [
  {
    ...
    text:
      "Attar United was born from a profound appreciation for time, beauty, and craftsmanship. Guided by heritage and inspired by excellence, Omar and Mohammed Saddik Attar transformed a lifelong passion into a vision—one that would redefine the luxury watch and jewelry experience in Saudi Arabia while setting new standards of elegance, trust, innovation, and enduring client relationships nationwide."
  },
  {
    year: "2013 - 2015",
    title: "Introducing Timeless Elegance",
    text:
      "With the arrival of Chopard in the Kingdom, Attar United began shaping a new language of luxury—where intimacy, artistry, and personal connection took center stage. These early years laid the foundation for enduring partnerships with the world's most prestigious maisons, establishing Attar United as a trusted name in high watchmaking and fine jewelry across the Kingdom confidently."
  },
  {
    year: "2016",
    title: "A Moment That Spoke to the World",
    text:
      "The opening of Hublot's largest boutique globally marked a defining chapter in Attar United's journey. More than a milestone, it was a statement of confidence—reflecting Saudi Arabia's rising presence on the global luxury stage and Attar United's role as a partner capable of delivering excellence at scale while continuing to inspire discerning clients and shaping the future."
  },
  {
    year: "2017 - 2019",
    title: "Strengthening the Pillars of Prestige",
    text:
      "During this defining period, Attar United focused on strengthening its core maisons, Chopard and Hublot, expanding their presence across the Kingdom's key luxury destinations. With boutiques established in Riyadh, Al Khobar, and Jeddah, these years were dedicated to deepening brand partnerships and refining the client experience that reflected the distinct identities of each maison."
  },
  {
    year: "2020",
    title: "Icons Aligned",
    text:
      "In a year that tested resilience worldwide, Attar United reached new heights. The unveiling of Chopard's flagship boutique in Riyadh and the introduction of Graff to Saudi Arabia marked a powerful alignment of vision, prestige, and trust—positioning Attar United among the region's most distinguished luxury retailers while continuing to elevate client experiences, foster lasting partnerships for generations."
  },
  {
    year: "2021",
    title: "The Poetry of Crystal",
    text:
      "Attar United expanded its universe of craftsmanship with the arrival of Saint Louis. Bringing centuries of French crystal artistry to the Kingdom, this chapter added a new dimension of refinement and celebrated beauty beyond timepieces while embracing exceptional heritage and design enthusiasts through timeless creations, meaningful experiences, enduring partnerships, innovation, together."
  },
  {
    year: "2023",
    title: "Honoring Artistry and Independence",
    text:
      "A year defined by creative expression and individuality, Attar United became the exclusive retailer for Azza Fahmy in Saudi Arabia—celebrating heritage through contemporary design. In the same year, the partnership with Gerald Charles led to the launch of the world's first mono-brand boutique, reaffirming a commitment to independent haute horlogerie while inspiring collectors, lasting excellence."
  },
  {
    year: "2024",
    title: "Celebration of Craft and Community",
    text:
      "The grand opening of Azza Fahmy was more than a milestone—it was a celebration of shared values, artistry, and meaningful connections. An intimate gathering of the brand's closest friends and clients reflected Attar United's belief that true luxury is deeply personal while creating unforgettable experiences rooted in trust, craftsmanship, enduring relationships across the Kingdom."
  },
  {
    year: "2025",
    title: "The Future, Crafted in Time",
    text:
      "Attar United enters a new chapter with the opening of flagship Chopard and Hublot boutiques at Solitaire Mall. These spaces embody the future of luxury retail in Saudi Arabia—where innovation meets tradition, and every moment is curated with intention and enduring vision while welcoming discerning clients through immersive experiences that celebrate heritage, excellence, together always."
  }
];
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3
                  className="
                    font-baskerville
                    text-2xl sm:text-xl md:text-3xl lg:text-3xl
